                        ...
                        <div class="row">
                            <div class="col-12">
                                ...
                                <label class="input-label text--black" for="exampleFormControlInput1"> {{translate('messages.Free_trial_period')}} ({{translate('messages.days')}})</label>
                                    <input type="number" value="{{ isset($free_trial_period['data']) ? $free_trial_period['data'] : ''}}" name="free_trial_period" class="form-control h--45px" placeholder="{{ translate('Ex:_90_Days') }}" min="1" step="1" required>
                                </div>
                            </div>
                        </div>
