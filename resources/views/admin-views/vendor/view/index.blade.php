                                                ...
                                                @if ($f_date == 'pdf')
                                                    <div class="attachment-card min-w-260">
                                                        ...
                                                        <a href="{{ asset('storage/app/public/additional_documents/'.$file) }}" target="_blank" rel="noopener noreferrer">
                                                            <div class="img">
                                                                    {{-- <iframe src='https://view.officeapps.live.com/op/embed.aspx?src={{ asset('storage/app/public/additional_documents/'.$file) }}' width='px' height='px' frameborder='0'>
                                                                    </iframe> --}}
                                                        ...
                                                        {{-- <iframe src='https://view.officeapps.live.com/op/embed.aspx?src={{ asset('
                                                            storage/app/public/additional_documents/'.$item) }}' width='px' height='px'
                                                            frameborder='0'>
                                                        </iframe> --}}
