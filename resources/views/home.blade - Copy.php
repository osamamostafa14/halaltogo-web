...
@section('content')
    ...
    <!-- <section class="banner-section"
        style="background: url('{{asset('storage/app/public/header_image')}}/{{$landing_data['header_bg_image']}}') no-repeat center center / cover">
        ...
        <div class="container">
            <div class="banner-wrapper">
                <div class="banner-thumb wow fadeInUp">
                    <img class="main-img"
                    src="{{asset('storage/app/public/header_image')}}/{{ $landing_data['header_content_image']   }}"
        ...
        <div class="container">
            ...
            @if (isset($landing_data['why_choose_us_image_1']))
                ...
                <div class="choose-item wow animate__dropIn">
                                <img
                    src="{{asset('storage/app/public/why_choose_us_image')}}/{{ $landing_data['why_choose_us_image_1'] }}"
                    alt="Image">
            ...
            @if (isset($landing_data['why_choose_us_image_2']))
                ...
                <div class="choose-item wow animate__dropIn">
                                <img
                    src="{{asset('storage/app/public/why_choose_us_image')}}/{{ $landing_data['why_choose_us_image_2'] }}"
                    alt="Image">
                    <div class="choose-item-content">
                        <div class="cont">
                            <h4 class="title">
            ...
            @if (isset($landing_data['why_choose_us_image_3']))
                ...
                <div class="choose-item wow animate__dropIn">
                                <img
                    src="{{asset('storage/app/public/why_choose_us_image')}}/{{ $landing_data['why_choose_us_image_3'] }}"
                    alt="Image">
                    <div class="choose-item-content">
                        <div class="cont">
                            <h4 class="title">
            ...
            @if (isset($landing_data['why_choose_us_image_4']))
                <div class="choose-item wow animate__dropIn">
                                <img
                    src="{{asset('storage/app/public/why_choose_us_image')}}/{{ $landing_data['why_choose_us_image_4'] }}"
                    alt="Image">
                    <div class="choose-item-content">
                        <div class="cont">
                            <h4 class="title">
