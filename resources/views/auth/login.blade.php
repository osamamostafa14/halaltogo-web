...
<head>
    ...
    @endphp
    <!-- Title -->
    <title>{{ translate('messages.login') }} | {{$app_name??translate('HalalToGo')}}</title>
                    ...
                    <div class="row p-2" id="reload-captcha">
                        <div class="col-6 pr-0">
                            <input type="text" class="form-control form-control-lg form-recapcha" name="custome_recaptcha"
                                    id="custome_recaptcha" required placeholder="Entrez la valeur recaptcha" autocomplete="off" value="{{env('APP_MODE')=='dev'? session('six_captcha'):''}}">
                        </div>
