<?php $__env->startSection('title', translate('Update_product')); ?>
            ...
            <div class="row g-2">
                                ...
                                <div class="lang_form"  id="default-form">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="name[]" id="default_name"
                                            class="form-control" value="<?php echo e($product?->getRawOriginal('name')); ?>"
                                    ...
                                    <div class="form-group mb-0">
                                        ...
                                        <textarea type="text" name="description[]" class="form-control ckeditor min-height-154px"><?php echo $product?->getRawOriginal('description') ?? ''; ?></textarea>
                                    </div>
                            </div>
                                <?php if($language): ?>
                                    <?php $__currentLoopData = json_decode($language); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $lang): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        ...
                                        <div class="d-none lang_form" id="<?php echo e($lang); ?>-form">
                                                ...
                                                <div class="form-group mb-0">
                                                    ...
                                                    <textarea type="text" name="description[]" class="form-control ckeditor min-height-154px"><?php echo $translate[$lang]['description'] ?? ''; ?></textarea>
                                                </div>
                                            </div>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                <?php endif; ?>
                                    ...
                                    <div class="form-group mb-0">
                                        <label class="input-label"
                                            for="exampleFormControlSelect1"><?php echo e(translate('messages.restaurant')); ?><span
                                                ...
                                                title="<?php echo e(translate('select_restaurant')); ?>" required
                            ...
                            <div class="row g-2">
                                <div class="col-sm-6">
                                    <div class="form-group mb-0">
                                        ...
                                        <input type="time" name="available_time_starts" class="form-control"
                                            id="available_time_starts"  value="<?php echo e($product['available_time_starts']); ?>"
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group mb-0">
                                        ...
                                        <input type="time" name="available_time_ends" class="form-control" value="<?php echo e($product['available_time_ends']); ?>"
                            ...
                            <div class="row g-2">
                                <div class="col-md-3">
                                    <div class="form-group mb-0">
                                        ...
                                        <input type="number" min="0" max="999999999999.99"
                                            step="0.01" value="<?php echo e($product['price']); ?>" name="price" class="form-control"
                                ...
                                <div class="col-md-3">
                                    <div class="form-group mb-0">
                                        ...
                                        value="<?php echo e($product['discount']); ?>"  name="discount" class="form-control"
                                ...
                                <div class="col-md-3" id="maximum_cart_quantity">
                                    <div class="form-group mb-0">
                                        ...
                                        <input type="number" placeholder="<?php echo e(translate('messages.Ex:_10')); ?>" class="form-control" name="maximum_cart_quantity" min="0" value="<?php echo e($product->maximum_cart_quantity); ?>" id="cart_quantity">
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="col-lg-12">
                    <div class="card shadow--card-2 border-0">
                        ...
                        <div class="card-body">
                            <input type="text" class="form-control" name="tags"  value="<?php $__currentLoopData = $product->tags; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $c): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?> <?php echo e($c->tag.','); ?> <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>" placeholder="Enter tags" data-role="tagsinput">
                        </div>
                    </div>
                </div>
                <div class="col-lg-12">
...
<?php $__env->startPush('script_2'); ?>
    <script>
        ...
        $(document).ready(function() {
            ...
            getRestaurantData('<?php echo e(url('/')); ?>/admin/restaurant/get-addons?<?php $__currentLoopData = json_decode($product['add_ons'], true); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $addon): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>data[]=<?php echo e($addon); ?>& <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?> restaurant_id=','<?php echo e($product['restaurant_id']); ?>','add_on');
            <?php else: ?>
            getRestaurantData('<?php echo e(url('/')); ?>/admin/restaurant/get-addons?data[]=0&restaurant_id=','<?php echo e($product['restaurant_id']); ?>','add_on');
            <?php endif; ?>
        });
    </script>
...
<?php echo $__env->make('layouts.admin.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\halaltogo\resources\views/admin-views/product/edit.blade.php ENDPATH**/ ?>